                                            ...
                                            <Tab.Pane active={activeTab === "assignments"}>
                                                ...
                                                {assignments.length === 0 ? (
                                                    <div className="text-center py-5">
                                                        ...
                                                        <h5 className="text-muted mb-2">No Assignments Available</h5>
                                                        <p className="text-muted mb-3">Create the first assignment for students to practice</p>
                                                        <Button
                                                            style={{ background: "#fbbf24", border: "none", color: "#000" }}
                                                            onClick={() => navigate(`/instructor/assignments/create/${courseId}`)}
                                                        >
                                                                                ...
                                                                                <div className="text-end">
                                                                                    <div className="mb-2">
                                                                                        <div className="d-flex align-items-center justify-content-end gap-2 mb-1">
                                                                                            ...
                                                                                            <span className="small text-muted">Submission Rate</span>
                                                                                        </div>
