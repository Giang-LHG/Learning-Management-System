                        ...
                        return (
                          ...
                          >
                            <div className="d-flex align-items-start">
                              <div
                                className={`rounded-circle text-white d-flex align-items-center justify-content-center me-4 ${isInstructor ? 'bg-primary' : 'bg-info'
                                  }`}
                                style={{
                                  width: '50px',
                                  height: '50px',
                              ...
                              <div className="flex-grow-1">
                                ...
                                <div
                                  className={`p-4 rounded-3 ${isInstructor
                                    ? 'text-white'
                                    : 'bg-light'
                                    }`}
                                  style={{
